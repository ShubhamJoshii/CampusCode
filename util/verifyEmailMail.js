const verifyEmailMail = (userName, verificationLink) => `
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    <div class="email-container">
      ...
      <div class="content">
        ...
        <p>
          Confirm your email, and start creating stunning emails and landing
          pages.
        </p>
        <img
        ...
        <p>
          Just a heads-up, this confirmation link has a 14-day expiration. If
          those days slip away, you need to sign up again.
        </p>
